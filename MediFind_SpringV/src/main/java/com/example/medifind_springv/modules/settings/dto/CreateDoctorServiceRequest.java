...
public class CreateDoctorServiceRequest {
    ...
    public CreateDoctorServiceRequest() {}

    public CreateDoctorServiceRequest(String doctorId, String name, String description, Integer durationMinutes, Double price, String locationId, String clinicId) {
