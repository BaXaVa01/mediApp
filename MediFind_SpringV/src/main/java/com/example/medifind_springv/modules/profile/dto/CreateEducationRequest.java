...
public class CreateEducationRequest {
    ...
    public CreateEducationRequest() {}

    public CreateEducationRequest(String doctorId, String title, String institution, Integer startYear, Integer endYear, String description) {
